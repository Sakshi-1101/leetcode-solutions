...
class DLLNode {
    ...
    public DLLNode(int key, int val) {
        this.key = key;
        this.val = val;
        this.freq = 1; // leep the initial freq as always 1
    }
}
...
class DoublyLL {
    ...
    // to remove the node and decrement the size of list by 1
    ...
    // to add node at front and increment the size of list by 1
